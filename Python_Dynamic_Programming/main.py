import sys
import select
from dynamic_programming import *  # Import dynamic programming solver 
...
# Solve each problem using the dynamic programming solver
for problem in problems:
    solver = DP_Solver(problem, otto_speed, load_time, pstart, pgoal)
    print(solver.solve())
